...
class Lifecycle(Installer):
    ...
    def repair(self, operation_id: str | None = None) -> dict[str, object]:
        ...
        # Reapply even a healthy receipt so repair converges Odyssey-owned host
        # integration generated by an older release.
    ...
    def _transition(self, kind, artifact, digest, identity, manifest, install, old,
        ...
        try:
            ...
            # The candidate adapter owns migrations of Odyssey-generated host
            # integration while the old release remains available for rollback.
            adapter = self.paths.manager_releases / candidate / "scripts/startupctl.sh"
